    ...
    schemas: {
      ...
      CreateChallengeResponse: {
        ...
        properties: {
          session_id: {
            type: "string",
            description: "Unique session identifier for polling and redemption",
          },
          deep_link: {
            type: "string",
            description: "Deep link URL to open Provii Wallet (https://provii.app/verify?d=...)",
          },
          expires_at: {
            type: "integer",
        ...
        required: ["session_id", "deep_link", "expires_at", "status_url"],
      ...
      StatusResponse: {
        ...
        properties: {
          ...
          verified: {
            type: "boolean",
            description: "Whether age verification succeeded",
          },
          proof_verified: {
            type: "boolean",
            description: "Whether the ZK proof was verified",
          },
        },
      ...
      RedeemResponse: {
        ...
        properties: {
          result: {
            type: "string",
            description: "Result of the redemption",
          },
          verified: {
            type: "boolean",
      ...
      ConfigResponse: {
        ...
        properties: {
          verifier_api_url: {
            type: "string",
            description: "Verifier API URL being used",
          },
          client_id: {
            type: "string",
            description: "Client ID (if configured)",
          },
          api_key_configured: {
            type: "boolean",
          ...
          hmac_secret_configured: {
            type: "boolean",
            description: "Whether HMAC secret is set",
          },
        },
        required: ["verifier_api_url", "api_key_configured", "hmac_secret_configured"],
        description: "Configuration info",
      },
      ErrorResponse: {
        type: "object",
        properties: {
          ...
          reference: {
            type: "string",
            description: "Error reference ID for debugging",
          },
        },
        required: ["error"],
